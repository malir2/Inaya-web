                                        ...
                                        <ul className="mt-7">
                                            <li onMouseEnter={() => setHoverTab(0)}
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <p className={`${hoverTab === 0 || activeTab === 0 ? "text-white" : "text-[rgb(190,190,190)]"} text-[0.8rem] xxl:text-[1rem]`}>Commodtive Overview</p>
                                                </div>
                                            </li>
                                        ...
                                        <ul className="mt-7">
                                            <li onMouseEnter={() => setHoverTab(0)}
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <p className={`${hoverTab === 0 || activeTab === 0 ? "text-white" : "text-[rgb(190,190,190)]"}`}>Commodtive Overview</p>
                                                </div>
                                            </li>
                                            <li onMouseEnter={() => setHoverTab(1)}
