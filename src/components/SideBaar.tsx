        ...
        <>
            <div className="lg:relative">
                <div className="lg:sticky top-2">
                    ...
                    <div className={`absolute top-0 left-0 h-screen backdrop-blur-sm  ${isSidebarOpen ? "w-[100%]" : "w-0 overflow-hidden"} z-[999999] transition-all duration-300 ease-in-out`}>
                        <div className={`sidebar ${theme === "dark" ? "bg-dark" : "bg-custom-gradient-two"} rounded-xl flex flex-col justify-between  fixed top-0 left-0 h-screen overflow-y-auto rounded-tl-none rounded-bl-none lg:hidden w-[17rem]`}>
                    ...
                    <div className="lg:hidden">
                        <span onClick={() => setIsSidebarOpen(!isSidebarOpen)} className="fa-solid fa-bars text-white text-xl cursor-pointer absolute top-2 left-3 lg:hidden mt-[0.6rem] z-[9999999]"></span>
                    </div>
                </div>
            </div>
        </>
