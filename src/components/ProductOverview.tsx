...
export default function ProductOverview() {
    ...
    return (
        <>
            <div className={`absolute ${showTab ? "top-0" : "top-[-100%]"} transition-all duration-700 left-0 w-full h-full backdrop-blur-sm z-[999]`}>
                <Configuration setShowTab={setShowTab} />
            </div>
            <div className="w-[100%]">
                {/* Header Section */}
                ...
                <div className="mt-3 xl:translate-y-[-13%] xl:mt-[-45px] flex justify-center relative z-[999]">
                    <button onClick={() => {
                        setShowTab(true)
