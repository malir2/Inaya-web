            ...
            <div className={`rounded-xl shadow-2xl overflow-hidden mb-[0rem] sm:mb-[-1rem] w-[22rem] sm:w-[28rem] lg:w-[35rem] ${theme === "dark" ? "bg-light" : "bg-white"} chat-screen`}>
                <div className={`${theme === "dark" ? "bg-yellow" : "bg-blue"} px-5 py-2 flex justify-between`}>
                    <div className="flex items-center gap-3">
                        <div>
                            <h1 className="text-white">Product Configuration</h1>
                        </div>
                    </div>
                ...
                <div className="px-5 scrollbar">
                    ...
                    {tab === 3 && <div className="form mt-4">
                        <div className="flex items-center gap-6">
                            <div className="grid grid-cols-2 gap-8 w-[100%]">
                                <div className="flex flex-col">
                                    <label htmlFor="" className={`${theme === "dark" ? "text-white" : "text-black"}`}>Raw Material #1</label>
                            ...
                            <span className={`fa-solid fa-trash-can mt-5 ${theme === "dark" ? "text-white" : "text-black"}`}></span>
                        </div>
                        <div className="flex items-center gap-6 mt-3">
                            <div className="grid grid-cols-2 gap-8 w-[100%]">
                                <div className="flex flex-col">
                                    <label htmlFor="" className={`${theme === "dark" ? "text-white" : "text-black"}`}>Raw Material #2</label>
                                    <input type="text" placeholder="Palm Oil" className={`px-4 py-3 mt-1 rounded-lg ${theme === "dark" ? "config-input" : "config-input-light"}`} />
                                </div>
                                <div className="flex flex-col">
                                    <label htmlFor="" className={`${theme === "dark" ? "text-white" : "text-black"}`}>Percentage</label>
                        ...
                        <div className="flex items-center gap-6 mt-3">
                            <div className="grid grid-cols-2 gap-8 w-[100%]">
                                <div className="flex flex-col">
                                    <label htmlFor="" className={`${theme === "dark" ? "text-white" : "text-black"}`}>Raw Material #3</label>
                                    <input type="text" placeholder="Palm Oil" className={`px-4 py-3 mt-1 rounded-lg ${theme === "dark" ? "config-input" : "config-input-light"}`} />
                                </div>
                                <div className="flex flex-col">
                                    <label htmlFor="" className={`${theme === "dark" ? "text-white" : "text-black"}`}>Percentage</label>
                    ...
                    {tab === 3 && <div className="flex justify-between mt-7 mb-5">
                        <div className="flex items-center gap-2">
                            <span className={`fa-solid fa-plus ${theme === "dark" ? "text-white" : "text-[#264570]"}`}></span>
                            <p className={`${theme === "dark" ? "text-white" : "text-[#264570]"} underline`}>Add raw material</p></div>
                        <button onClick={() => {
                            setTab(4)
