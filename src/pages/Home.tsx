...
function Home() {
    ...
    return (
        <>
            <div className="flex justify-center lg:justify-between lg:gap-4 w-full bg-light h-auto p-5 relative">
                <div>
                    <div>
                        {/* Sidebar for big screens */}
                        <div className="w-[17rem] hidden sidebar bg-dark rounded-xl lg:flex flex-col justify-between">
                            <div>
                            ...
                            <div className="px-4 mt-[7rem] mb-6">
